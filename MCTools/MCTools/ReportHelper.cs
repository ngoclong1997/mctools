...
namespace MCTools
{
    public static class ReportHelper
    {
        ...
        public static void exportReport(DataGridView editedReport, DataGridView preEditingReport)
        {
        ...
        public static void exportPreEditedReport_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (exportEditedReportComplete && exportFinalReportComplete && exportPreEditedReportComplete)
            {
        ...
        private static Excel.Worksheet preEditedReportFormat(DataGridView dgv, Excel.Worksheet xlWorkSheet)
        {
            ...
            xlWorkSheet = insertHeader(dgv, xlWorkSheet, "BIÊN BẢN CHẤM THI TRẮC NGHIỆM TRƯỚC SỬA LỖI", Globals.examName, Globals.subject, false);
            return xlWorkSheet;
        }
